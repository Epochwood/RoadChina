...
public class MarkingF extends Block
{
            ...
            switch (state.getValue(BLOCK_TYPE)) {
                case FULL_BLOCK:
                    switch (state.getValue(FACING)) {
                        case SOUTH:
                            return Block.box(0.0D, 0.0D, 16.0D, 16.0D, 0.0D, -16.0D);
                        case NORTH:
                        default:
                            return Block.box(0.0D, 0.0D, 0.0D, 16.0D, 0.0D, 32.0D);
                        case EAST:
                            return Block.box(16.0D, 0.0D, 0.0D, -16.0D, 0.0D, 16.0D);
                        case WEST:
                            return Block.box(0.0D, 0.0D, 0.0D, 32.0D, 0.0D, 16.0D);
                    }
                case SLAB_BLOCK:
                    switch (state.getValue(FACING)) {
                        case SOUTH:
                            return Block.box(0.0D, -8.0D, 16.0D, 16.0D, -8.0D, -16.0D);
                        case NORTH:
                        default:
                            return Block.box(0.0D, -8.0D, 0.0D, 16.0D, -8.0D, 32.0D);
                        case EAST:
                            return Block.box(16.0D, -8.0D, 0.0D, -16.0D, -8.0D, 16.0D);
                        case WEST:
                            return Block.box(0.0D, -8.0D, 0.0D, 32.0D, -8.0D, 16.0D);
                    }
            }
        return null;
    }
